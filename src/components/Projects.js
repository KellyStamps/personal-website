  ...
  render(){
    return (
      ...
      <div className='video-1'>
        ...
        <ReactPlayer className='video' url="https://youtu.be/pus0LMkY-4U" width="510px" height="230px"/>
      ...
      <div className='video-2'>
        ...
        <ReactPlayer className='video' url="https://youtu.be/6lECuoTIYco" width="510px" height="230px"/>
      ...
      <div className='video-3'>
        ...
        <ReactPlayer className='video' url="https://youtu.be/Riu_P4xfWLU" width="510px" height="230px" />
